// audit-trail/src/bin/generate_ats_key.rs
...
fn main() {
    ...
    println!("=== PRIVATE KEY (simpan di ATS_PRIVATE_KEY_PEM di .env) ===");
    println!("{}", private_pem.as_str());

    println!("\n=== PUBLIC KEY (hardcode di ATS_SERVER_PUBLIC_KEY_PEM di constants.rs) ===");
    println!("{public_pem}");
}