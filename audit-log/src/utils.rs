...
impl Utils {
    ...
    pub fn als_private_key_pem() -> String {
        std::env::var("ALS_PRIVATE_KEY_PEM")
            .expect("ALS_PRIVATE_KEY_PEM harus di-set di environment")
    ...
    pub fn decrypt_event(
        ...
        let private_key_pem = std::env::var("ALS_PRIVATE_KEY_PEM")
            .expect("ALS_PRIVATE_KEY_PEM harus di-set")
            .replace("\\n", "\n");
        ...
        // 2. Dekripsi AES key dengan private key ALS
