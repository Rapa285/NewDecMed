...
pub const LOG_ROTATION_INTERVAL_SECS: u64 = 30;
pub const LOG_DIR: &str = "./logs";
pub const LOG_FILE_PATH: &str = "./logs/audit_logs.txt";
...
pub const ALS_PACKAGE_ID: &str = "0x693e47423514f4b302ba753ef71c03913acb2b472ae5cbe855fffc430ef8f213";
pub const AUDIT_LOG_STORE_OBJECT_ID: &str = "0x6e0e9f252a35317ceea75b9a443a130b8bba9ef44cd5bb67359660ec68925372";
pub const AUDIT_LOG_STORE_INITIAL_SHARED_VERSION: u64 = 5;

// Revisi
pub const ALS_SIGNING_PUBLIC_KEY_HEX: &str = "..."; // pubkey AES master ALS
pub const DEFAULT_LOGS_PAGE_SIZE: u64 = 25;
pub const MAX_LOGS_PAGE_SIZE: u64 = 100;