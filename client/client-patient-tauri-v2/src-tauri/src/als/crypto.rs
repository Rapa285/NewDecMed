//! Utilitas kriptografi untuk ALS:
//! - Enkripsi AES-256-GCM
//! - ECDH key wrapping dengan public key ALS server
...
/// Enkripsi AES key dengan public key ALS server menggunakan ECDH + AES-KW
///
/// Flow:
/// 1. Generate ephemeral P-256 keypair
/// 2. ECDH dengan ALS server public key → shared secret
...
/// Dekripsi enc_aes_key (hasil ecies_encrypt_key) dengan private key ALS server
